...
The associated research was submitted to the **Organization of Human Brain Mapping (OHBM) 2026 Annual Meeting** in Bordeaux (FR). The plan is to present in the poster section. Because the code and results might change slightly due to article revisions, the state of this repository during poster submission is archived in the form of a release. At the time of making the release, it was unknown whether my poster will be accepted. In the case of acceptance, links will be added to the published poster.

The code was originally used in the diploma thesis *Analysis of White Matter Diffusion Properties in the Context of Selected Brain Tumors* produced at the **Department of Computer Science and Engineering, Faculty of Applied Sciences, University of West Bohemia**, from which the academic article is derived. The state of this repository during thesis submission and defense is also archived in the form of a release. The thesis was successfully defended on 16th June 2025 and can be accessed from URL:
